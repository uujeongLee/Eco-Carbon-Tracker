package egovframework.com.cst.crypto.test;
...
public class EgovEnvCryptoUserTest {
    ...
    public static void main(String[] args) {
        ...
        String[] arrCryptoString = { 
                "sundo",         //데이터베이스 접속 계정 설정
                "sundo123#",   //데이터베이스 접속 패드워드 설정
                "url",            //데이터베이스 접속 주소 설정
                "databaseDriver"  //데이터베이스 드라이버
        };
  
        LOGGER.info("------------------------------------------------------");      
        ApplicationContext context = new ClassPathXmlApplicationContext(new String[]{"classpath:/config/test/context-crypto-test.xml"});
